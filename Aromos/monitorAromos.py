...
# Nombre de sensores
SENSOR_ESTANQUE = "SSR_AROMOS--slave.estanque"

# --- Logging ---
BASE_DIR = os.path.dirname(os.path.abspath(__file__))
LOG_FILE = os.path.join(BASE_DIR, "logs_AROMOS.txt")
...
def monitorear():
    while True:
        ...
        alerta_estanque_1 = procesar_estanque(SENSOR_ESTANQUE, "Estanque", nivel_alerta, divisor=1)
        
        alerta_global = alerta_estanque_1
