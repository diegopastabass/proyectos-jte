...
SENSOR_NIVEL_P1 = "SSR_GONZALEZ--slave.metalico1"
SENSOR_NIVEL_P2 = "SSR_GONZALEZ--slave.metalico2"
...
if __name__ == "__main__":
    try:
        while True:
            monitorear(0.5, 3, SENSOR_NIVEL_P1, 1, "Estanque Viejo")
            monitorear(0.5, 3, SENSOR_NIVEL_P2, 1, "Estanque Nuevo")
