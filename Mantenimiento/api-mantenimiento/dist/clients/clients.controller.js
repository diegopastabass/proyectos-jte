...
let ClientsController = class ClientsController {
    ...
    async create(dto) {
        try {
            ...
            throw new common_1.InternalServerErrorException(`Error fetching clients by Id: ${error.message}`);
        }
    }
    async findOne(id) {
        try {
    ...
    async findAllClients() {
        try {
            ...
            throw new common_1.InternalServerErrorException(`Error fetching clients: ${error.message}`);
        }
    }
};
