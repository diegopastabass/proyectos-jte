...
function Navbar(props: NavbarProps) {
  ...
  return (
    <nav
      className="navbar navbar-expand-lg navbar-light bg-light rounded shadow-sm mb-2 mt-2 mx-auto px-3"
    ...
    >
      <div className="container-fluid d-flex flex-wrap align-items-center justify-content-between gap-3">
        ...
        <a
          ...
          href="/mantenimiento/"
        >
          <img src={logo_jt2} alt="logo" width={50} height={34} />
          <span className="h5 mb-0">Informe Técnico</span>
        </a>
      </div>{" "}
