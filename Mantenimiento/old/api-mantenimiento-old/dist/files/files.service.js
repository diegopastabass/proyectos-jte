...
let FilesService = class FilesService {
    ...
    async findFileByMaintenanceId(maintenanceId) {
        try {
            ...
            if (!file) {
                throw new common_1.NotFoundException(`File with Maintenance ID ${maintenanceId} not found`);
            }
            return file;
        }
        catch (error) {
            throw new Error(`Error finding file for this maintenance session: ${error.message}`);
        }
    }
};
