...
exports.SsrPuQuillayService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const metrics_entity_1 = require("./models/metrics.entity");
let SsrPuQuillayService = class SsrPuQuillayService {
    repo;
    constructor(repo) {
        this.repo = repo;
    }
  ...
  `);
        ...
        const estanque1 = await calcularTiempoVaciado('SSR_PUQUILLAY--slave.metalico1');
        const estanque2 = await calcularTiempoVaciado('SSR_PUQUILLAY--slave.metalico2');
        return {
            snapshot,
...
exports.SsrPuQuillayService = SsrPuQuillayService;
exports.SsrPuQuillayService = SsrPuQuillayService = __decorate([
