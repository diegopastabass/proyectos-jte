...
const ParcelaMapa: React.FC<ParcelaMapaProps> = ({
  ...
  const style = (feature: Feature<Geometry, any> | undefined) => {
    const isActive =
      feature?.properties?.name && activeMap[feature.properties.name]
        ? activeMap[feature.properties.name]
        : false;
    return {
  ...
  return (
    <div className="container mt-3">
      <div className="border rounded" style={{ height: "500px" }}>
        <MapContainer
          center={[-34.46422177239996, -70.97225015463609]}
          zoom={15}
        ...
        >
          ...
          <Marker position={[-34.4645013294097, -70.97543150728679]}>
            <Popup>
