...
__decorate([
    (0, typeorm_1.ManyToOne)(() => session_entity_1.Session, (session) => session.measurements, {
        onDelete: 'CASCADE',
    }),
    (0, typeorm_1.JoinColumn)({ name: 'sesion_id' }),
    __metadata("design:type", session_entity_1.Session)
], Measurement.prototype, "session", void 0);
__decorate([
...
__decorate([
    ...
    __metadata("design:type", String)
], Measurement.prototype, "imagePath", void 0);
exports.Measurement = Measurement = __decorate([
    (0, typeorm_1.Entity)('measures')
], Measurement);
